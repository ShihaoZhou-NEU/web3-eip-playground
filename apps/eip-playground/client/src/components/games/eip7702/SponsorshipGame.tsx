  ...
  return (
    <div className="w-full max-w-4xl mx-auto p-8 bg-gray-900 border-4 border-white font-pixel text-white relative overflow-hidden mt-8 shadow-[8px_8px_0px_0px_rgba(0,0,0,0.5)]">
      ...
      <div className="relative min-h-[300px] flex flex-col items-center justify-center gap-8 bg-black/30 border-2 border-white/10 p-4">
        ...
        >
          {hasApple ? (
            <div className="w-16 h-16 bg-yellow-400 border-4 border-white shadow-[4px_4px_0px_0px_rgba(0,0,0,0.5)] flex items-center justify-center text-2xl">
              🍎
            </div>
          ) : (
            <div className="w-16 h-16 bg-green-400 border-4 border-white shadow-[4px_4px_0px_0px_rgba(0,0,0,0.5)] flex items-center justify-center text-2xl opacity-50">
              🍏
            </div>
          )}
        </motion.div>
