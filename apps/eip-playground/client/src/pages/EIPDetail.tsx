...
export default function EIPDetail() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background text-foreground font-sans selection:bg-primary selection:text-primary-foreground" style={{
      ...
      <main className="flex-1 container py-12">
        {/* Hero Section */}
        <div className={`relative rounded-xl overflow-hidden p-8 md:p-12 mb-12 border-4 border-white/20 ${eip.gradient}`}>
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="text-center md:text-left">
              <div className="flex items-center justify-center md:justify-start gap-4 mb-2">
                <h1 className="text-4xl md:text-6xl font-pixel text-white text-shadow-pixel">{eip.title}</h1>
